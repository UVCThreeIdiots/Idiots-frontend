...
const emailCheck = () => {
  ...
  axiosInstance.post("http://13.125.169.9:5173/other/email", JSON.stringify(data), {
    headers: {
...
const timeCapsuleSubmit = () => {
  ...
  formData.append("expired", `${formattedDate.value}T00:00:00+09:00`); // datetime 형식으로 변환된 값
