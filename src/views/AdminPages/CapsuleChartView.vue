...
const fetchCapsuleData = async () => {
  try {
    const response = await axiosInstance.get('http://13.125.169.9:3000/time/allTCapsules');
    timeCapsules.value = response.data;
    const response2 = await axiosInstance.get('http://13.125.169.9:3000/goal/all');
