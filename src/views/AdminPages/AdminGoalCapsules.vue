        ...
        <div class="header">
          ...
          <div>
            <select v-model="searchKey" class="select">
              ...
              <option value="isSuccess">isSuccess</option>
            </select>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th class="isSuccess" @click="sortCapsules('isSuccess')">Is Success</th>
      ...
      <div v-if="showCapsuleDetailsModal" class="modal">
        <div class="modal-content">
          ...
          <div class="details-content">
            ...
            <p><strong>Goal Count :</strong> {{ selectedCapsule.goalCount }}</p>
            <p><strong>Goal Term :</strong> {{ selectedCapsule.goalTerm }}</p>
            <p><strong>Now Count :</strong> {{ selectedCapsule.nowCount }}</p>
            <p><strong>Progress :</strong> {{ (selectedCapsule.nowCount / selectedCapsule.goalCount * 100).toFixed(2) }}%</p>
            <p><strong>Image Path:</strong> {{ selectedCapsule.imagePath }}</p>
            <p><strong>Created At :</strong> {{ selectedCapsule.createdAt }}</p>
            <p><strong>Is Failed :</strong> {{ selectedCapsule.isFailed }}</p>
            <p><strong>Is Success :</strong> {{ selectedCapsule.isSuccess }}</p>
...
const capsulesData = () => {
  axiosInstance.get(`http://13.125.169.9:5173/goal/all`)
    .then(response => {
...
const deleteCapsule = async (id) => {
  try {
    await axiosInstance.delete(`http://13.125.169.9:5173/time/deleteTcapsule/${id}`);
